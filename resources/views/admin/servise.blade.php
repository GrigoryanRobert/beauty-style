            ...
            <table class="table table-hover table-responsive">
                ...
                @foreach($servises as $servise)
                    <tr id="servise-{{$servise['id']}}">
                        ...
                        <td><button type="button" data-toggle="modal" data-target="#edit" data-uid="1" class="update btn btn-warning btn-sm servise-update"><span class="glyphicon glyphicon-pencil"></span></button></td>
