...
Route::prefix('admin')->group(function(){
    ...
    Route::get('/add_category', 'Admin\AdminCategoryController@add_category')->name('admin.categoryadd');
    Route::post('/add_category', 'Admin\AdminCategoryController@add_category_post')->name('admin.categoryaddpost');
    Route::get('/edit_category/{id}', 'Admin\AdminCategoryController@edit_category');
    Route::post('/edit_categories/{id}', 'Admin\AdminCategoryController@edit_category_post');
